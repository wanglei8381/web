...
router.get('/noteDetail', routeMap.note.noteDetail);
router.get('/noteApproval', routeMap.note.noteApproval);
...
router.get('/myjobDetail', routeMap.job.myjobDetail);
router.get('/jobDetail', routeMap.job.jobDetail);
router.get('/jobEdit', routeMap.job.jobEdit);
...
router.get('/myresourceDetail', routeMap.resource.myresourceDetail);
router.get('/resourceDetail', routeMap.resource.resourceDetail);
router.get('/resourceEdit', routeMap.resource.resourceEdit);
